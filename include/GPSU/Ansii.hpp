...
namespace GPSU
{
    namespace Ansii
    {
        ...
        public:
            ...
            inline const CodeList& operator+=(const Code& code) { _content.push_back(code); }
            inline const CodeList& operator+=(const CodeList& other) { _content.insert(_content.end(), other.Content().begin(), other.Content().end()); }
        ...
        template<Modes mode, class... TArgs>
        inline Code Color256Code(unsigned char color, TArgs... args)
        {
            return ModeCode<mode>(Colors::ExtendedSet, 5, static_cast<int>(color), args...);
        }
        
        template<Modes mode, class... TArgs>
        inline Code RGBColorCode(unsigned char r, unsigned char g, unsigned char b, TArgs... args)
        {
            return ModeCode<mode>(Colors::ExtendedSet, 2, static_cast<int>(r), static_cast<int>(g), static_cast<int>(b), args...);
        }
        
        template<class... TArgs>
        inline Code Unmoded(TArgs... args) { return ModeCode<Modes::None>(args...); }
        template<class... TArgs>
        inline Code Boldness(TArgs... args) { return ModeCode<Modes::Boldness>(args...); }
        template<class... TArgs>
        inline Code Underline(TArgs... args) { return ModeCode<Modes::Underline>(args...); }
        template<class... TArgs>
        inline Code Font(TArgs... args) { return ModeCode<Modes::Fonts>(args...); }
        template<class... TArgs>
        inline Code Foreground(TArgs... args) { return ModeCode<Modes::Foreground>(args...); }
        template<class... TArgs>
        inline Code Background(TArgs... args) { return ModeCode<Modes::Background>(args...); }
        template<class... TArgs>
        inline Code Foreground256(TArgs... args) { return Color256Code<Modes::Foreground>(args...); }
        template<class... TArgs>
        inline Code Background256(TArgs... args) { return Color256Code<Modes::Background>(args...); }
        template<class... TArgs>
        inline Code ForegroundRGB(TArgs... args) { return RGBColorCode<Modes::Foreground>(args...); }
        template<class... TArgs>
        inline Code BackgroundRGB(TArgs... args) { return RGBColorCode<Modes::Background>(args...); }
